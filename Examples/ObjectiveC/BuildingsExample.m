...
- (void)viewDidLoad {
    ...
    mapView.camera = [MGLMapCamera cameraLookingAtCenterCoordinate:CLLocationCoordinate2DMake(48.8582602, 2.29449905431968) fromDistance:600 pitch:60 heading:210];
